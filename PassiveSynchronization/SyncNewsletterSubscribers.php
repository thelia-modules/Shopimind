...
class SyncNewsletterSubscribers
{
     ...
     */
    public function processSyncNewsletterSubscribers($lastUpdate, $ids, $requestedBy, $idShopAskSyncs): array
    {
     ...
     * @return void
     */
    public function syncNewsletterSubscribers(Request $request): void
    {
        try {
