...
class ProductImagesData
{
     ...
     * @throws \Throwable
     */
    public static function formatProductImage(ProductImage $productImage, Lang $lang, EventDispatcherInterface $dispatcher, string $action = 'insert'): array
    {
        $data = [];
        if ($action == 'insert') {
            ...
            $data = [
                ...
                'lang' => $lang->getCode(),
                'url' => $url,
                'is_default' => $productImage->getPosition() == 1,
            ];
        }
